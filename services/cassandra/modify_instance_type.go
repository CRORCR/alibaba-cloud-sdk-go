...
// api document: https://help.aliyun.com/api/cassandra/modifyinstancetype.html
...
func CreateModifyInstanceTypeRequest() (request *ModifyInstanceTypeRequest) {
	...
	request.InitWithApiInfo("Cassandra", "2019-01-01", "ModifyInstanceType", "Cassandra", "openAPI")
