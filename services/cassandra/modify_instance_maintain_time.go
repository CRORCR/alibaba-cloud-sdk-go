...
// api document: https://help.aliyun.com/api/cassandra/modifyinstancemaintaintime.html
...
func CreateModifyInstanceMaintainTimeRequest() (request *ModifyInstanceMaintainTimeRequest) {
	...
	request.InitWithApiInfo("Cassandra", "2019-01-01", "ModifyInstanceMaintainTime", "Cassandra", "openAPI")
