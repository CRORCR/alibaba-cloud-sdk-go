...
// api document: https://help.aliyun.com/api/cassandra/describesecuritygroups.html
...
func CreateDescribeSecurityGroupsRequest() (request *DescribeSecurityGroupsRequest) {
	...
	request.InitWithApiInfo("Cassandra", "2019-01-01", "DescribeSecurityGroups", "Cassandra", "openAPI")
