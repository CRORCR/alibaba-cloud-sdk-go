...
// api document: https://help.aliyun.com/api/cassandra/modifyipwhitelist.html
...
func CreateModifyIpWhitelistRequest() (request *ModifyIpWhitelistRequest) {
	...
	request.InitWithApiInfo("Cassandra", "2019-01-01", "ModifyIpWhitelist", "Cassandra", "openAPI")
