...
// ReportHour invokes the cloudwf.ReportHour API synchronously
// api document: https://help.aliyun.com/api/cloudwf/reporthour.html
func (client *Client) ReportHour(request *ReportHourRequest) (response *ReportHourResponse, err error) {
	response = CreateReportHourResponse()
	err = client.DoAction(request, response)
	return
}

// ReportHourWithChan invokes the cloudwf.ReportHour API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/reporthour.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ReportHourWithChan(request *ReportHourRequest) (<-chan *ReportHourResponse, <-chan error) {
	responseChan := make(chan *ReportHourResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.ReportHour(request)
		if err != nil {
			errChan <- err
		} else {
...
// ReportHourWithCallback invokes the cloudwf.ReportHour API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/reporthour.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ReportHourWithCallback(request *ReportHourRequest, callback func(response *ReportHourResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ReportHourResponse
		var err error
		defer close(result)
		response, err = client.ReportHour(request)
...
func CreateReportHourRequest() (request *ReportHourRequest) {
	request = &ReportHourRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("cloudwf", "2017-03-28", "ReportHour", "cloudwf", "openAPI")
	return
}
