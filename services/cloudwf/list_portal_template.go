...
// ListPortalTemplate invokes the cloudwf.ListPortalTemplate API synchronously
// api document: https://help.aliyun.com/api/cloudwf/listportaltemplate.html
func (client *Client) ListPortalTemplate(request *ListPortalTemplateRequest) (response *ListPortalTemplateResponse, err error) {
	response = CreateListPortalTemplateResponse()
	err = client.DoAction(request, response)
	return
}

// ListPortalTemplateWithChan invokes the cloudwf.ListPortalTemplate API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/listportaltemplate.html
...
func (client *Client) ListPortalTemplateWithChan(request *ListPortalTemplateRequest) (<-chan *ListPortalTemplateResponse, <-chan error) {
	responseChan := make(chan *ListPortalTemplateResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.ListPortalTemplate(request)
		if err != nil {
			errChan <- err
		} else {
...
// ListPortalTemplateWithCallback invokes the cloudwf.ListPortalTemplate API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/listportaltemplate.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ListPortalTemplateWithCallback(request *ListPortalTemplateRequest, callback func(response *ListPortalTemplateResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ListPortalTemplateResponse
		var err error
		defer close(result)
		response, err = client.ListPortalTemplate(request)
...
func CreateListPortalTemplateRequest() (request *ListPortalTemplateRequest) {
	request = &ListPortalTemplateRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("cloudwf", "2017-03-28", "ListPortalTemplate", "cloudwf", "openAPI")
	return
}
...
func CreateListPortalTemplateResponse() (response *ListPortalTemplateResponse) {
	response = &ListPortalTemplateResponse{
