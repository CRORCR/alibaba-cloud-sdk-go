...
// KickAndClearPMKcache invokes the cloudwf.KickAndClearPMKcache API synchronously
// api document: https://help.aliyun.com/api/cloudwf/kickandclearpmkcache.html
...
// KickAndClearPMKcacheWithChan invokes the cloudwf.KickAndClearPMKcache API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/kickandclearpmkcache.html
...
// KickAndClearPMKcacheWithCallback invokes the cloudwf.KickAndClearPMKcache API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/kickandclearpmkcache.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateKickAndClearPMKcacheRequest() (request *KickAndClearPMKcacheRequest) {
	...
	request.InitWithApiInfo("cloudwf", "2017-03-28", "KickAndClearPMKcache", "cloudwf", "openAPI")
	return
}
