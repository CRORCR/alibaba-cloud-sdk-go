...
// ListConfigByAction invokes the cloudwf.ListConfigByAction API synchronously
// api document: https://help.aliyun.com/api/cloudwf/listconfigbyaction.html
func (client *Client) ListConfigByAction(request *ListConfigByActionRequest) (response *ListConfigByActionResponse, err error) {
	response = CreateListConfigByActionResponse()
	err = client.DoAction(request, response)
	return
}

// ListConfigByActionWithChan invokes the cloudwf.ListConfigByAction API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/listconfigbyaction.html
...
func (client *Client) ListConfigByActionWithChan(request *ListConfigByActionRequest) (<-chan *ListConfigByActionResponse, <-chan error) {
	responseChan := make(chan *ListConfigByActionResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.ListConfigByAction(request)
		if err != nil {
			errChan <- err
		} else {
...
// ListConfigByActionWithCallback invokes the cloudwf.ListConfigByAction API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/listconfigbyaction.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ListConfigByActionWithCallback(request *ListConfigByActionRequest, callback func(response *ListConfigByActionResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ListConfigByActionResponse
		var err error
		defer close(result)
		response, err = client.ListConfigByAction(request)
...
func CreateListConfigByActionRequest() (request *ListConfigByActionRequest) {
	request = &ListConfigByActionRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("cloudwf", "2017-03-28", "ListConfigByAction", "cloudwf", "openAPI")
	return
}
...
func CreateListConfigByActionResponse() (response *ListConfigByActionResponse) {
	response = &ListConfigByActionResponse{
