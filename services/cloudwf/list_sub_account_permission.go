...
// ListSubAccountPermission invokes the cloudwf.ListSubAccountPermission API synchronously
// api document: https://help.aliyun.com/api/cloudwf/listsubaccountpermission.html
func (client *Client) ListSubAccountPermission(request *ListSubAccountPermissionRequest) (response *ListSubAccountPermissionResponse, err error) {
	response = CreateListSubAccountPermissionResponse()
	err = client.DoAction(request, response)
	return
}

// ListSubAccountPermissionWithChan invokes the cloudwf.ListSubAccountPermission API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/listsubaccountpermission.html
...
func (client *Client) ListSubAccountPermissionWithChan(request *ListSubAccountPermissionRequest) (<-chan *ListSubAccountPermissionResponse, <-chan error) {
	responseChan := make(chan *ListSubAccountPermissionResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.ListSubAccountPermission(request)
		if err != nil {
			errChan <- err
		} else {
...
// ListSubAccountPermissionWithCallback invokes the cloudwf.ListSubAccountPermission API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/listsubaccountpermission.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ListSubAccountPermissionWithCallback(request *ListSubAccountPermissionRequest, callback func(response *ListSubAccountPermissionResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ListSubAccountPermissionResponse
		var err error
		defer close(result)
		response, err = client.ListSubAccountPermission(request)
...
func CreateListSubAccountPermissionRequest() (request *ListSubAccountPermissionRequest) {
	request = &ListSubAccountPermissionRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("cloudwf", "2017-03-28", "ListSubAccountPermission", "cloudwf", "openAPI")
	return
}
...
func CreateListSubAccountPermissionResponse() (response *ListSubAccountPermissionResponse) {
	response = &ListSubAccountPermissionResponse{
