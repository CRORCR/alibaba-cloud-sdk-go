...
// SaveGroupApRadioConfig invokes the cloudwf.SaveGroupApRadioConfig API synchronously
// api document: https://help.aliyun.com/api/cloudwf/savegroupapradioconfig.html
func (client *Client) SaveGroupApRadioConfig(request *SaveGroupApRadioConfigRequest) (response *SaveGroupApRadioConfigResponse, err error) {
	response = CreateSaveGroupApRadioConfigResponse()
	err = client.DoAction(request, response)
	return
}

// SaveGroupApRadioConfigWithChan invokes the cloudwf.SaveGroupApRadioConfig API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/savegroupapradioconfig.html
...
func (client *Client) SaveGroupApRadioConfigWithChan(request *SaveGroupApRadioConfigRequest) (<-chan *SaveGroupApRadioConfigResponse, <-chan error) {
	responseChan := make(chan *SaveGroupApRadioConfigResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.SaveGroupApRadioConfig(request)
		if err != nil {
			errChan <- err
		} else {
...
// SaveGroupApRadioConfigWithCallback invokes the cloudwf.SaveGroupApRadioConfig API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/savegroupapradioconfig.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) SaveGroupApRadioConfigWithCallback(request *SaveGroupApRadioConfigRequest, callback func(response *SaveGroupApRadioConfigResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *SaveGroupApRadioConfigResponse
		var err error
		defer close(result)
		response, err = client.SaveGroupApRadioConfig(request)
...
func CreateSaveGroupApRadioConfigRequest() (request *SaveGroupApRadioConfigRequest) {
	request = &SaveGroupApRadioConfigRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("cloudwf", "2017-03-28", "SaveGroupApRadioConfig", "cloudwf", "openAPI")
	return
}
...
func CreateSaveGroupApRadioConfigResponse() (response *SaveGroupApRadioConfigResponse) {
	response = &SaveGroupApRadioConfigResponse{
