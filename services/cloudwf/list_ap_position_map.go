...
// ListApPositionMap invokes the cloudwf.ListApPositionMap API synchronously
// api document: https://help.aliyun.com/api/cloudwf/listappositionmap.html
func (client *Client) ListApPositionMap(request *ListApPositionMapRequest) (response *ListApPositionMapResponse, err error) {
	response = CreateListApPositionMapResponse()
	err = client.DoAction(request, response)
	return
}

// ListApPositionMapWithChan invokes the cloudwf.ListApPositionMap API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/listappositionmap.html
...
func (client *Client) ListApPositionMapWithChan(request *ListApPositionMapRequest) (<-chan *ListApPositionMapResponse, <-chan error) {
	responseChan := make(chan *ListApPositionMapResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.ListApPositionMap(request)
		if err != nil {
			errChan <- err
		} else {
...
// ListApPositionMapWithCallback invokes the cloudwf.ListApPositionMap API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/listappositionmap.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ListApPositionMapWithCallback(request *ListApPositionMapRequest, callback func(response *ListApPositionMapResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ListApPositionMapResponse
		var err error
		defer close(result)
		response, err = client.ListApPositionMap(request)
...
func CreateListApPositionMapRequest() (request *ListApPositionMapRequest) {
	request = &ListApPositionMapRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("cloudwf", "2017-03-28", "ListApPositionMap", "cloudwf", "openAPI")
	return
}
...
func CreateListApPositionMapResponse() (response *ListApPositionMapResponse) {
	response = &ListApPositionMapResponse{
