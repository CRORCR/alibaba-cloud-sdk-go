...
// InnerProduceCloudWF invokes the cloudwf.InnerProduceCloudWF API synchronously
// api document: https://help.aliyun.com/api/cloudwf/innerproducecloudwf.html
...
// InnerProduceCloudWFWithChan invokes the cloudwf.InnerProduceCloudWF API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/innerproducecloudwf.html
...
// InnerProduceCloudWFWithCallback invokes the cloudwf.InnerProduceCloudWF API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/innerproducecloudwf.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateInnerProduceCloudWFRequest() (request *InnerProduceCloudWFRequest) {
	...
	request.InitWithApiInfo("cloudwf", "2017-03-28", "InnerProduceCloudWF", "cloudwf", "openAPI")
	return
}
