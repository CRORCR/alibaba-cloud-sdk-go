...
// ReleaseInstance invokes the cloudwf.ReleaseInstance API synchronously
// api document: https://help.aliyun.com/api/cloudwf/releaseinstance.html
...
// ReleaseInstanceWithChan invokes the cloudwf.ReleaseInstance API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/releaseinstance.html
...
// ReleaseInstanceWithCallback invokes the cloudwf.ReleaseInstance API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/releaseinstance.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateReleaseInstanceRequest() (request *ReleaseInstanceRequest) {
	...
	request.InitWithApiInfo("cloudwf", "2017-03-28", "ReleaseInstance", "cloudwf", "openAPI")
	return
}
