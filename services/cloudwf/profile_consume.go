...
// ProfileConsume invokes the cloudwf.ProfileConsume API synchronously
// api document: https://help.aliyun.com/api/cloudwf/profileconsume.html
...
// ProfileConsumeWithChan invokes the cloudwf.ProfileConsume API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/profileconsume.html
...
// ProfileConsumeWithCallback invokes the cloudwf.ProfileConsume API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/profileconsume.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateProfileConsumeRequest() (request *ProfileConsumeRequest) {
	...
	request.InitWithApiInfo("cloudwf", "2017-03-28", "ProfileConsume", "cloudwf", "openAPI")
	return
}
