...
// SaveApgroupSsidConfig invokes the cloudwf.SaveApgroupSsidConfig API synchronously
// api document: https://help.aliyun.com/api/cloudwf/saveapgroupssidconfig.html
func (client *Client) SaveApgroupSsidConfig(request *SaveApgroupSsidConfigRequest) (response *SaveApgroupSsidConfigResponse, err error) {
	response = CreateSaveApgroupSsidConfigResponse()
	err = client.DoAction(request, response)
	return
}

// SaveApgroupSsidConfigWithChan invokes the cloudwf.SaveApgroupSsidConfig API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/saveapgroupssidconfig.html
...
func (client *Client) SaveApgroupSsidConfigWithChan(request *SaveApgroupSsidConfigRequest) (<-chan *SaveApgroupSsidConfigResponse, <-chan error) {
	responseChan := make(chan *SaveApgroupSsidConfigResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.SaveApgroupSsidConfig(request)
		if err != nil {
			errChan <- err
		} else {
...
// SaveApgroupSsidConfigWithCallback invokes the cloudwf.SaveApgroupSsidConfig API asynchronously
// api document: https://help.aliyun.com/api/cloudwf/saveapgroupssidconfig.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) SaveApgroupSsidConfigWithCallback(request *SaveApgroupSsidConfigRequest, callback func(response *SaveApgroupSsidConfigResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *SaveApgroupSsidConfigResponse
		var err error
		defer close(result)
		response, err = client.SaveApgroupSsidConfig(request)
...
func CreateSaveApgroupSsidConfigRequest() (request *SaveApgroupSsidConfigRequest) {
	request = &SaveApgroupSsidConfigRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("cloudwf", "2017-03-28", "SaveApgroupSsidConfig", "cloudwf", "openAPI")
	return
}
...
func CreateSaveApgroupSsidConfigResponse() (response *SaveApgroupSsidConfigResponse) {
	response = &SaveApgroupSsidConfigResponse{
