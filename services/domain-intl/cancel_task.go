...
// CancelTask invokes the domain_intl.CancelTask API synchronously
// api document: https://help.aliyun.com/api/domain-intl/canceltask.html
...
// CancelTaskWithChan invokes the domain_intl.CancelTask API asynchronously
// api document: https://help.aliyun.com/api/domain-intl/canceltask.html
...
// CancelTaskWithCallback invokes the domain_intl.CancelTask API asynchronously
// api document: https://help.aliyun.com/api/domain-intl/canceltask.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateCancelTaskRequest() (request *CancelTaskRequest) {
	...
	request.InitWithApiInfo("Domain-intl", "2017-12-18", "CancelTask", "domain", "openAPI")
	return
}
