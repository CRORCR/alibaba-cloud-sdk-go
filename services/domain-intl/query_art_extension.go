...
// QueryArtExtension invokes the domain_intl.QueryArtExtension API synchronously
// api document: https://help.aliyun.com/api/domain-intl/queryartextension.html
...
// QueryArtExtensionWithChan invokes the domain_intl.QueryArtExtension API asynchronously
// api document: https://help.aliyun.com/api/domain-intl/queryartextension.html
...
// QueryArtExtensionWithCallback invokes the domain_intl.QueryArtExtension API asynchronously
// api document: https://help.aliyun.com/api/domain-intl/queryartextension.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateQueryArtExtensionRequest() (request *QueryArtExtensionRequest) {
	...
	request.InitWithApiInfo("Domain-intl", "2017-12-18", "QueryArtExtension", "domain", "openAPI")
	return
}
