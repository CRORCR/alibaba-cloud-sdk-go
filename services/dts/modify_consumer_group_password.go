...
// api document: https://help.aliyun.com/api/dts/modifyconsumergrouppassword.html
...
func CreateModifyConsumerGroupPasswordRequest() (request *ModifyConsumerGroupPasswordRequest) {
	...
	request.InitWithApiInfo("Dts", "2018-08-01", "ModifyConsumerGroupPassword", "dts", "openAPI")
	return
}
