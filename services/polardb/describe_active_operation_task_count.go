...
// api document: https://help.aliyun.com/api/polardb/describeactiveoperationtaskcount.html
...
func CreateDescribeActiveOperationTaskCountRequest() (request *DescribeActiveOperationTaskCountRequest) {
	...
	request.InitWithApiInfo("polardb", "2017-08-01", "DescribeActiveOperationTaskCount", "polardb", "openAPI")
