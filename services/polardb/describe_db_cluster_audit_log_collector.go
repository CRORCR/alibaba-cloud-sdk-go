...
// api document: https://help.aliyun.com/api/polardb/describedbclusterauditlogcollector.html
...
func CreateDescribeDBClusterAuditLogCollectorRequest() (request *DescribeDBClusterAuditLogCollectorRequest) {
	...
	request.InitWithApiInfo("polardb", "2017-08-01", "DescribeDBClusterAuditLogCollector", "polardb", "openAPI")
