...
// CheckPermission invokes the tdsr.CheckPermission API synchronously
// api document: https://help.aliyun.com/api/tdsr/checkpermission.html
...
// CheckPermissionWithChan invokes the tdsr.CheckPermission API asynchronously
// api document: https://help.aliyun.com/api/tdsr/checkpermission.html
...
// CheckPermissionWithCallback invokes the tdsr.CheckPermission API asynchronously
// api document: https://help.aliyun.com/api/tdsr/checkpermission.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateCheckPermissionRequest() (request *CheckPermissionRequest) {
	...
	request.InitWithApiInfo("tdsr", "2020-01-01", "CheckPermission", "", "")
