...
// DescribeSlsProject invokes the aegis.DescribeSlsProject API synchronously
// api document: https://help.aliyun.com/api/aegis/describeslsproject.html
func (client *Client) DescribeSlsProject(request *DescribeSlsProjectRequest) (response *DescribeSlsProjectResponse, err error) {
	response = CreateDescribeSlsProjectResponse()
	err = client.DoAction(request, response)
	return
}

// DescribeSlsProjectWithChan invokes the aegis.DescribeSlsProject API asynchronously
// api document: https://help.aliyun.com/api/aegis/describeslsproject.html
...
func (client *Client) DescribeSlsProjectWithChan(request *DescribeSlsProjectRequest) (<-chan *DescribeSlsProjectResponse, <-chan error) {
	responseChan := make(chan *DescribeSlsProjectResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.DescribeSlsProject(request)
		if err != nil {
			errChan <- err
		} else {
...
// DescribeSlsProjectWithCallback invokes the aegis.DescribeSlsProject API asynchronously
// api document: https://help.aliyun.com/api/aegis/describeslsproject.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) DescribeSlsProjectWithCallback(request *DescribeSlsProjectRequest, callback func(response *DescribeSlsProjectResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *DescribeSlsProjectResponse
		var err error
		defer close(result)
		response, err = client.DescribeSlsProject(request)
...
func CreateDescribeSlsProjectRequest() (request *DescribeSlsProjectRequest) {
	request = &DescribeSlsProjectRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("aegis", "2016-11-11", "DescribeSlsProject", "vipaegis", "openAPI")
	return
}
...
func CreateDescribeSlsProjectResponse() (response *DescribeSlsProjectResponse) {
	response = &DescribeSlsProjectResponse{
