...
// DescribeWebLockMachineList invokes the aegis.DescribeWebLockMachineList API synchronously
// api document: https://help.aliyun.com/api/aegis/describeweblockmachinelist.html
func (client *Client) DescribeWebLockMachineList(request *DescribeWebLockMachineListRequest) (response *DescribeWebLockMachineListResponse, err error) {
	response = CreateDescribeWebLockMachineListResponse()
	err = client.DoAction(request, response)
	return
}

// DescribeWebLockMachineListWithChan invokes the aegis.DescribeWebLockMachineList API asynchronously
// api document: https://help.aliyun.com/api/aegis/describeweblockmachinelist.html
...
func (client *Client) DescribeWebLockMachineListWithChan(request *DescribeWebLockMachineListRequest) (<-chan *DescribeWebLockMachineListResponse, <-chan error) {
	responseChan := make(chan *DescribeWebLockMachineListResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.DescribeWebLockMachineList(request)
		if err != nil {
			errChan <- err
		} else {
...
// DescribeWebLockMachineListWithCallback invokes the aegis.DescribeWebLockMachineList API asynchronously
// api document: https://help.aliyun.com/api/aegis/describeweblockmachinelist.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) DescribeWebLockMachineListWithCallback(request *DescribeWebLockMachineListRequest, callback func(response *DescribeWebLockMachineListResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *DescribeWebLockMachineListResponse
		var err error
		defer close(result)
		response, err = client.DescribeWebLockMachineList(request)
...
func CreateDescribeWebLockMachineListRequest() (request *DescribeWebLockMachineListRequest) {
	request = &DescribeWebLockMachineListRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("aegis", "2016-11-11", "DescribeWebLockMachineList", "vipaegis", "openAPI")
	return
}
...
func CreateDescribeWebLockMachineListResponse() (response *DescribeWebLockMachineListResponse) {
	response = &DescribeWebLockMachineListResponse{
