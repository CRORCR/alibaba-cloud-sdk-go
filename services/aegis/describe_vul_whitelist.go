...
// DescribeVulWhitelist invokes the aegis.DescribeVulWhitelist API synchronously
// api document: https://help.aliyun.com/api/aegis/describevulwhitelist.html
...
// DescribeVulWhitelistWithChan invokes the aegis.DescribeVulWhitelist API asynchronously
// api document: https://help.aliyun.com/api/aegis/describevulwhitelist.html
...
// DescribeVulWhitelistWithCallback invokes the aegis.DescribeVulWhitelist API asynchronously
// api document: https://help.aliyun.com/api/aegis/describevulwhitelist.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateDescribeVulWhitelistRequest() (request *DescribeVulWhitelistRequest) {
	...
	request.InitWithApiInfo("aegis", "2016-11-11", "DescribeVulWhitelist", "vipaegis", "openAPI")
	return
}
