...
// DescribeTraceInfoDetail invokes the aegis.DescribeTraceInfoDetail API synchronously
// api document: https://help.aliyun.com/api/aegis/describetraceinfodetail.html
func (client *Client) DescribeTraceInfoDetail(request *DescribeTraceInfoDetailRequest) (response *DescribeTraceInfoDetailResponse, err error) {
	response = CreateDescribeTraceInfoDetailResponse()
	err = client.DoAction(request, response)
	return
}

// DescribeTraceInfoDetailWithChan invokes the aegis.DescribeTraceInfoDetail API asynchronously
// api document: https://help.aliyun.com/api/aegis/describetraceinfodetail.html
...
func (client *Client) DescribeTraceInfoDetailWithChan(request *DescribeTraceInfoDetailRequest) (<-chan *DescribeTraceInfoDetailResponse, <-chan error) {
	responseChan := make(chan *DescribeTraceInfoDetailResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.DescribeTraceInfoDetail(request)
		if err != nil {
			errChan <- err
		} else {
...
// DescribeTraceInfoDetailWithCallback invokes the aegis.DescribeTraceInfoDetail API asynchronously
// api document: https://help.aliyun.com/api/aegis/describetraceinfodetail.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) DescribeTraceInfoDetailWithCallback(request *DescribeTraceInfoDetailRequest, callback func(response *DescribeTraceInfoDetailResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *DescribeTraceInfoDetailResponse
		var err error
		defer close(result)
		response, err = client.DescribeTraceInfoDetail(request)
...
func CreateDescribeTraceInfoDetailRequest() (request *DescribeTraceInfoDetailRequest) {
	request = &DescribeTraceInfoDetailRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("aegis", "2016-11-11", "DescribeTraceInfoDetail", "vipaegis", "openAPI")
	return
}
...
func CreateDescribeTraceInfoDetailResponse() (response *DescribeTraceInfoDetailResponse) {
	response = &DescribeTraceInfoDetailResponse{
