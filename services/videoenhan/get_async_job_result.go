...
// api document: https://help.aliyun.com/api/videoenhan/getasyncjobresult.html
...
func CreateGetAsyncJobResultRequest() (request *GetAsyncJobResultRequest) {
	...
	request.InitWithApiInfo("videoenhan", "2020-03-20", "GetAsyncJobResult", "videoenhan", "openAPI")
