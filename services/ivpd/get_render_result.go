...
// GetRenderResult invokes the ivpd.GetRenderResult API synchronously
// api document: https://help.aliyun.com/api/ivpd/getrenderresult.html
func (client *Client) GetRenderResult(request *GetRenderResultRequest) (response *GetRenderResultResponse, err error) {
	response = CreateGetRenderResultResponse()
	err = client.DoAction(request, response)
	return
}

// GetRenderResultWithChan invokes the ivpd.GetRenderResult API asynchronously
// api document: https://help.aliyun.com/api/ivpd/getrenderresult.html
...
func (client *Client) GetRenderResultWithChan(request *GetRenderResultRequest) (<-chan *GetRenderResultResponse, <-chan error) {
	responseChan := make(chan *GetRenderResultResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.GetRenderResult(request)
		if err != nil {
			errChan <- err
		} else {
...
// GetRenderResultWithCallback invokes the ivpd.GetRenderResult API asynchronously
// api document: https://help.aliyun.com/api/ivpd/getrenderresult.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) GetRenderResultWithCallback(request *GetRenderResultRequest, callback func(response *GetRenderResultResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *GetRenderResultResponse
		var err error
		defer close(result)
		response, err = client.GetRenderResult(request)
