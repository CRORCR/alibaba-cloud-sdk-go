...
// HighlightGameVideo invokes the ivpd.HighlightGameVideo API synchronously
// api document: https://help.aliyun.com/api/ivpd/highlightgamevideo.html
func (client *Client) HighlightGameVideo(request *HighlightGameVideoRequest) (response *HighlightGameVideoResponse, err error) {
	response = CreateHighlightGameVideoResponse()
	err = client.DoAction(request, response)
	return
}

// HighlightGameVideoWithChan invokes the ivpd.HighlightGameVideo API asynchronously
// api document: https://help.aliyun.com/api/ivpd/highlightgamevideo.html
...
func (client *Client) HighlightGameVideoWithChan(request *HighlightGameVideoRequest) (<-chan *HighlightGameVideoResponse, <-chan error) {
	responseChan := make(chan *HighlightGameVideoResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.HighlightGameVideo(request)
		if err != nil {
			errChan <- err
		} else {
...
// HighlightGameVideoWithCallback invokes the ivpd.HighlightGameVideo API asynchronously
// api document: https://help.aliyun.com/api/ivpd/highlightgamevideo.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) HighlightGameVideoWithCallback(request *HighlightGameVideoRequest, callback func(response *HighlightGameVideoResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *HighlightGameVideoResponse
		var err error
		defer close(result)
		response, err = client.HighlightGameVideo(request)
...
func CreateHighlightGameVideoRequest() (request *HighlightGameVideoRequest) {
	request = &HighlightGameVideoRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("ivpd", "2019-06-25", "HighlightGameVideo", "ivpd", "openAPI")
...
func CreateHighlightGameVideoResponse() (response *HighlightGameVideoResponse) {
	response = &HighlightGameVideoResponse{
