...
// GetAsyncJobResult invokes the ivpd.GetAsyncJobResult API synchronously
// api document: https://help.aliyun.com/api/ivpd/getasyncjobresult.html
...
// GetAsyncJobResultWithChan invokes the ivpd.GetAsyncJobResult API asynchronously
// api document: https://help.aliyun.com/api/ivpd/getasyncjobresult.html
...
// GetAsyncJobResultWithCallback invokes the ivpd.GetAsyncJobResult API asynchronously
// api document: https://help.aliyun.com/api/ivpd/getasyncjobresult.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateGetAsyncJobResultRequest() (request *GetAsyncJobResultRequest) {
	...
	request.InitWithApiInfo("ivpd", "2019-06-25", "GetAsyncJobResult", "ivpd", "openAPI")
