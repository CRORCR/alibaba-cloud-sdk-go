...
// api document: https://help.aliyun.com/api/iot/queryedgeinstancedevicebydriver.html
...
func CreateQueryEdgeInstanceDeviceByDriverRequest() (request *QueryEdgeInstanceDeviceByDriverRequest) {
	...
	request.InitWithApiInfo("Iot", "2018-01-20", "QueryEdgeInstanceDeviceByDriver", "iot", "openAPI")
