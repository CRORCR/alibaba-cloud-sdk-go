...
// api document: https://help.aliyun.com/api/iot/batchgetedgeinstancechannel.html
...
func CreateBatchGetEdgeInstanceChannelRequest() (request *BatchGetEdgeInstanceChannelRequest) {
	...
	request.InitWithApiInfo("Iot", "2018-01-20", "BatchGetEdgeInstanceChannel", "iot", "openAPI")
