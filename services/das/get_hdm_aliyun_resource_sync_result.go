...
// api document: https://help.aliyun.com/api/das/gethdmaliyunresourcesyncresult.html
...
func CreateGetHDMAliyunResourceSyncResultRequest() (request *GetHDMAliyunResourceSyncResultRequest) {
	...
	request.InitWithApiInfo("DAS", "2020-01-16", "GetHDMAliyunResourceSyncResult", "hdm", "openAPI")
