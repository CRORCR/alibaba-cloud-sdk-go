...
// ListBaseRolesByRole invokes the oam.ListBaseRolesByRole API synchronously
// api document: https://help.aliyun.com/api/oam/listbaserolesbyrole.html
func (client *Client) ListBaseRolesByRole(request *ListBaseRolesByRoleRequest) (response *ListBaseRolesByRoleResponse, err error) {
	response = CreateListBaseRolesByRoleResponse()
	err = client.DoAction(request, response)
	return
}

// ListBaseRolesByRoleWithChan invokes the oam.ListBaseRolesByRole API asynchronously
// api document: https://help.aliyun.com/api/oam/listbaserolesbyrole.html
...
func (client *Client) ListBaseRolesByRoleWithChan(request *ListBaseRolesByRoleRequest) (<-chan *ListBaseRolesByRoleResponse, <-chan error) {
	responseChan := make(chan *ListBaseRolesByRoleResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.ListBaseRolesByRole(request)
		if err != nil {
			errChan <- err
		} else {
...
// ListBaseRolesByRoleWithCallback invokes the oam.ListBaseRolesByRole API asynchronously
// api document: https://help.aliyun.com/api/oam/listbaserolesbyrole.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ListBaseRolesByRoleWithCallback(request *ListBaseRolesByRoleRequest, callback func(response *ListBaseRolesByRoleResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ListBaseRolesByRoleResponse
		var err error
		defer close(result)
		response, err = client.ListBaseRolesByRole(request)
...
func CreateListBaseRolesByRoleRequest() (request *ListBaseRolesByRoleRequest) {
	request = &ListBaseRolesByRoleRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Oam", "2017-01-01", "ListBaseRolesByRole", "", "")
...
func CreateListBaseRolesByRoleResponse() (response *ListBaseRolesByRoleResponse) {
	response = &ListBaseRolesByRoleResponse{
