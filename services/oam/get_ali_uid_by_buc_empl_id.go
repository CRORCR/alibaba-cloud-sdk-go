...
// GetAliUidByBucEmplId invokes the oam.GetAliUidByBucEmplId API synchronously
// api document: https://help.aliyun.com/api/oam/getaliuidbybucemplid.html
func (client *Client) GetAliUidByBucEmplId(request *GetAliUidByBucEmplIdRequest) (response *GetAliUidByBucEmplIdResponse, err error) {
	response = CreateGetAliUidByBucEmplIdResponse()
	err = client.DoAction(request, response)
	return
}

// GetAliUidByBucEmplIdWithChan invokes the oam.GetAliUidByBucEmplId API asynchronously
// api document: https://help.aliyun.com/api/oam/getaliuidbybucemplid.html
...
func (client *Client) GetAliUidByBucEmplIdWithChan(request *GetAliUidByBucEmplIdRequest) (<-chan *GetAliUidByBucEmplIdResponse, <-chan error) {
	responseChan := make(chan *GetAliUidByBucEmplIdResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.GetAliUidByBucEmplId(request)
		if err != nil {
			errChan <- err
		} else {
...
// GetAliUidByBucEmplIdWithCallback invokes the oam.GetAliUidByBucEmplId API asynchronously
// api document: https://help.aliyun.com/api/oam/getaliuidbybucemplid.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) GetAliUidByBucEmplIdWithCallback(request *GetAliUidByBucEmplIdRequest, callback func(response *GetAliUidByBucEmplIdResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *GetAliUidByBucEmplIdResponse
		var err error
		defer close(result)
		response, err = client.GetAliUidByBucEmplId(request)
...
func CreateGetAliUidByBucEmplIdRequest() (request *GetAliUidByBucEmplIdRequest) {
	request = &GetAliUidByBucEmplIdRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Oam", "2017-01-01", "GetAliUidByBucEmplId", "", "")
...
func CreateGetAliUidByBucEmplIdResponse() (response *GetAliUidByBucEmplIdResponse) {
	response = &GetAliUidByBucEmplIdResponse{
