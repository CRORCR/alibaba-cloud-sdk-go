...
// ListAllowedPermissions invokes the oam.ListAllowedPermissions API synchronously
// api document: https://help.aliyun.com/api/oam/listallowedpermissions.html
func (client *Client) ListAllowedPermissions(request *ListAllowedPermissionsRequest) (response *ListAllowedPermissionsResponse, err error) {
	response = CreateListAllowedPermissionsResponse()
	err = client.DoAction(request, response)
	return
}

// ListAllowedPermissionsWithChan invokes the oam.ListAllowedPermissions API asynchronously
// api document: https://help.aliyun.com/api/oam/listallowedpermissions.html
...
func (client *Client) ListAllowedPermissionsWithChan(request *ListAllowedPermissionsRequest) (<-chan *ListAllowedPermissionsResponse, <-chan error) {
	responseChan := make(chan *ListAllowedPermissionsResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.ListAllowedPermissions(request)
		if err != nil {
			errChan <- err
		} else {
...
// ListAllowedPermissionsWithCallback invokes the oam.ListAllowedPermissions API asynchronously
// api document: https://help.aliyun.com/api/oam/listallowedpermissions.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ListAllowedPermissionsWithCallback(request *ListAllowedPermissionsRequest, callback func(response *ListAllowedPermissionsResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ListAllowedPermissionsResponse
		var err error
		defer close(result)
		response, err = client.ListAllowedPermissions(request)
...
func CreateListAllowedPermissionsRequest() (request *ListAllowedPermissionsRequest) {
	request = &ListAllowedPermissionsRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Oam", "2017-01-01", "ListAllowedPermissions", "", "")
...
func CreateListAllowedPermissionsResponse() (response *ListAllowedPermissionsResponse) {
	response = &ListAllowedPermissionsResponse{
