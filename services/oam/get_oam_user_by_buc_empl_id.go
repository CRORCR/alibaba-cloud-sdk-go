...
// GetOamUserByBucEmplId invokes the oam.GetOamUserByBucEmplId API synchronously
// api document: https://help.aliyun.com/api/oam/getoamuserbybucemplid.html
func (client *Client) GetOamUserByBucEmplId(request *GetOamUserByBucEmplIdRequest) (response *GetOamUserByBucEmplIdResponse, err error) {
	response = CreateGetOamUserByBucEmplIdResponse()
	err = client.DoAction(request, response)
	return
}

// GetOamUserByBucEmplIdWithChan invokes the oam.GetOamUserByBucEmplId API asynchronously
// api document: https://help.aliyun.com/api/oam/getoamuserbybucemplid.html
...
func (client *Client) GetOamUserByBucEmplIdWithChan(request *GetOamUserByBucEmplIdRequest) (<-chan *GetOamUserByBucEmplIdResponse, <-chan error) {
	responseChan := make(chan *GetOamUserByBucEmplIdResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.GetOamUserByBucEmplId(request)
		if err != nil {
			errChan <- err
		} else {
...
// GetOamUserByBucEmplIdWithCallback invokes the oam.GetOamUserByBucEmplId API asynchronously
// api document: https://help.aliyun.com/api/oam/getoamuserbybucemplid.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) GetOamUserByBucEmplIdWithCallback(request *GetOamUserByBucEmplIdRequest, callback func(response *GetOamUserByBucEmplIdResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *GetOamUserByBucEmplIdResponse
		var err error
		defer close(result)
		response, err = client.GetOamUserByBucEmplId(request)
...
func CreateGetOamUserByBucEmplIdRequest() (request *GetOamUserByBucEmplIdRequest) {
	request = &GetOamUserByBucEmplIdRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Oam", "2017-01-01", "GetOamUserByBucEmplId", "", "")
...
func CreateGetOamUserByBucEmplIdResponse() (response *GetOamUserByBucEmplIdResponse) {
	response = &GetOamUserByBucEmplIdResponse{
