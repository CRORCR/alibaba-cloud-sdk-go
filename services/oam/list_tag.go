...
// ListTag invokes the oam.ListTag API synchronously
// api document: https://help.aliyun.com/api/oam/listtag.html
func (client *Client) ListTag(request *ListTagRequest) (response *ListTagResponse, err error) {
	response = CreateListTagResponse()
	err = client.DoAction(request, response)
	return
}

// ListTagWithChan invokes the oam.ListTag API asynchronously
// api document: https://help.aliyun.com/api/oam/listtag.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ListTagWithChan(request *ListTagRequest) (<-chan *ListTagResponse, <-chan error) {
	responseChan := make(chan *ListTagResponse, 1)
...
// ListTagWithCallback invokes the oam.ListTag API asynchronously
// api document: https://help.aliyun.com/api/oam/listtag.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateListTagRequest() (request *ListTagRequest) {
	...
	request.InitWithApiInfo("Oam", "2017-01-01", "ListTag", "", "")
