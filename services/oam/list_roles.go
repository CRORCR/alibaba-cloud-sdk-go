...
// ListRoles invokes the oam.ListRoles API synchronously
// api document: https://help.aliyun.com/api/oam/listroles.html
...
// ListRolesWithChan invokes the oam.ListRoles API asynchronously
// api document: https://help.aliyun.com/api/oam/listroles.html
...
// ListRolesWithCallback invokes the oam.ListRoles API asynchronously
// api document: https://help.aliyun.com/api/oam/listroles.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateListRolesRequest() (request *ListRolesRequest) {
	...
	request.InitWithApiInfo("Oam", "2017-01-01", "ListRoles", "", "")
