...
// TransferRole invokes the oam.TransferRole API synchronously
// api document: https://help.aliyun.com/api/oam/transferrole.html
func (client *Client) TransferRole(request *TransferRoleRequest) (response *TransferRoleResponse, err error) {
	response = CreateTransferRoleResponse()
	err = client.DoAction(request, response)
	return
}

// TransferRoleWithChan invokes the oam.TransferRole API asynchronously
// api document: https://help.aliyun.com/api/oam/transferrole.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) TransferRoleWithChan(request *TransferRoleRequest) (<-chan *TransferRoleResponse, <-chan error) {
	responseChan := make(chan *TransferRoleResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.TransferRole(request)
		if err != nil {
			errChan <- err
		} else {
...
// TransferRoleWithCallback invokes the oam.TransferRole API asynchronously
// api document: https://help.aliyun.com/api/oam/transferrole.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) TransferRoleWithCallback(request *TransferRoleRequest, callback func(response *TransferRoleResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *TransferRoleResponse
		var err error
		defer close(result)
		response, err = client.TransferRole(request)
...
func CreateTransferRoleRequest() (request *TransferRoleRequest) {
	request = &TransferRoleRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Oam", "2017-01-01", "TransferRole", "", "")
