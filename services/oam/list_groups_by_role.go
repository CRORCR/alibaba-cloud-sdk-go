...
// ListGroupsByRole invokes the oam.ListGroupsByRole API synchronously
// api document: https://help.aliyun.com/api/oam/listgroupsbyrole.html
func (client *Client) ListGroupsByRole(request *ListGroupsByRoleRequest) (response *ListGroupsByRoleResponse, err error) {
	response = CreateListGroupsByRoleResponse()
	err = client.DoAction(request, response)
	return
}

// ListGroupsByRoleWithChan invokes the oam.ListGroupsByRole API asynchronously
// api document: https://help.aliyun.com/api/oam/listgroupsbyrole.html
...
func (client *Client) ListGroupsByRoleWithChan(request *ListGroupsByRoleRequest) (<-chan *ListGroupsByRoleResponse, <-chan error) {
	responseChan := make(chan *ListGroupsByRoleResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.ListGroupsByRole(request)
		if err != nil {
			errChan <- err
		} else {
...
// ListGroupsByRoleWithCallback invokes the oam.ListGroupsByRole API asynchronously
// api document: https://help.aliyun.com/api/oam/listgroupsbyrole.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ListGroupsByRoleWithCallback(request *ListGroupsByRoleRequest, callback func(response *ListGroupsByRoleResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ListGroupsByRoleResponse
		var err error
		defer close(result)
		response, err = client.ListGroupsByRole(request)
...
func CreateListGroupsByRoleRequest() (request *ListGroupsByRoleRequest) {
	request = &ListGroupsByRoleRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Oam", "2017-01-01", "ListGroupsByRole", "", "")
...
func CreateListGroupsByRoleResponse() (response *ListGroupsByRoleResponse) {
	response = &ListGroupsByRoleResponse{
