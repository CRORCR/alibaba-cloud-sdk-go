...
// GetGroup invokes the oam.GetGroup API synchronously
// api document: https://help.aliyun.com/api/oam/getgroup.html
...
// GetGroupWithChan invokes the oam.GetGroup API asynchronously
// api document: https://help.aliyun.com/api/oam/getgroup.html
...
// GetGroupWithCallback invokes the oam.GetGroup API asynchronously
// api document: https://help.aliyun.com/api/oam/getgroup.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateGetGroupRequest() (request *GetGroupRequest) {
	...
	request.InitWithApiInfo("Oam", "2017-01-01", "GetGroup", "", "")
