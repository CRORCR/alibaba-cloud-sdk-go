...
// UnfreezeAntChainAccount invokes the baas.UnfreezeAntChainAccount API synchronously
// api document: https://help.aliyun.com/api/baas/unfreezeantchainaccount.html
func (client *Client) UnfreezeAntChainAccount(request *UnfreezeAntChainAccountRequest) (response *UnfreezeAntChainAccountResponse, err error) {
	response = CreateUnfreezeAntChainAccountResponse()
	err = client.DoAction(request, response)
	return
}

// UnfreezeAntChainAccountWithChan invokes the baas.UnfreezeAntChainAccount API asynchronously
// api document: https://help.aliyun.com/api/baas/unfreezeantchainaccount.html
...
func (client *Client) UnfreezeAntChainAccountWithChan(request *UnfreezeAntChainAccountRequest) (<-chan *UnfreezeAntChainAccountResponse, <-chan error) {
	responseChan := make(chan *UnfreezeAntChainAccountResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.UnfreezeAntChainAccount(request)
		if err != nil {
			errChan <- err
		} else {
...
// UnfreezeAntChainAccountWithCallback invokes the baas.UnfreezeAntChainAccount API asynchronously
// api document: https://help.aliyun.com/api/baas/unfreezeantchainaccount.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) UnfreezeAntChainAccountWithCallback(request *UnfreezeAntChainAccountRequest, callback func(response *UnfreezeAntChainAccountResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *UnfreezeAntChainAccountResponse
		var err error
		defer close(result)
		response, err = client.UnfreezeAntChainAccount(request)
...
func CreateUnfreezeAntChainAccountRequest() (request *UnfreezeAntChainAccountRequest) {
	request = &UnfreezeAntChainAccountRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Baas", "2018-12-21", "UnfreezeAntChainAccount", "baas", "openAPI")
	return
}
...
func CreateUnfreezeAntChainAccountResponse() (response *UnfreezeAntChainAccountResponse) {
	response = &UnfreezeAntChainAccountResponse{
