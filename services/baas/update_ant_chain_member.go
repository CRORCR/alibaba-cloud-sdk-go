...
// UpdateAntChainMember invokes the baas.UpdateAntChainMember API synchronously
// api document: https://help.aliyun.com/api/baas/updateantchainmember.html
func (client *Client) UpdateAntChainMember(request *UpdateAntChainMemberRequest) (response *UpdateAntChainMemberResponse, err error) {
	response = CreateUpdateAntChainMemberResponse()
	err = client.DoAction(request, response)
	return
}

// UpdateAntChainMemberWithChan invokes the baas.UpdateAntChainMember API asynchronously
// api document: https://help.aliyun.com/api/baas/updateantchainmember.html
...
func (client *Client) UpdateAntChainMemberWithChan(request *UpdateAntChainMemberRequest) (<-chan *UpdateAntChainMemberResponse, <-chan error) {
	responseChan := make(chan *UpdateAntChainMemberResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.UpdateAntChainMember(request)
		if err != nil {
			errChan <- err
		} else {
...
// UpdateAntChainMemberWithCallback invokes the baas.UpdateAntChainMember API asynchronously
// api document: https://help.aliyun.com/api/baas/updateantchainmember.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) UpdateAntChainMemberWithCallback(request *UpdateAntChainMemberRequest, callback func(response *UpdateAntChainMemberResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *UpdateAntChainMemberResponse
		var err error
		defer close(result)
		response, err = client.UpdateAntChainMember(request)
...
func CreateUpdateAntChainMemberRequest() (request *UpdateAntChainMemberRequest) {
	request = &UpdateAntChainMemberRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Baas", "2018-12-21", "UpdateAntChainMember", "baas", "openAPI")
	return
}
...
func CreateUpdateAntChainMemberResponse() (response *UpdateAntChainMemberResponse) {
	response = &UpdateAntChainMemberResponse{
