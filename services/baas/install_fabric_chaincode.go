...
// InstallFabricChaincode invokes the baas.InstallFabricChaincode API synchronously
// api document: https://help.aliyun.com/api/baas/installfabricchaincode.html
func (client *Client) InstallFabricChaincode(request *InstallFabricChaincodeRequest) (response *InstallFabricChaincodeResponse, err error) {
	response = CreateInstallFabricChaincodeResponse()
	err = client.DoAction(request, response)
	return
}

// InstallFabricChaincodeWithChan invokes the baas.InstallFabricChaincode API asynchronously
// api document: https://help.aliyun.com/api/baas/installfabricchaincode.html
...
func (client *Client) InstallFabricChaincodeWithChan(request *InstallFabricChaincodeRequest) (<-chan *InstallFabricChaincodeResponse, <-chan error) {
	responseChan := make(chan *InstallFabricChaincodeResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.InstallFabricChaincode(request)
		if err != nil {
			errChan <- err
		} else {
...
// InstallFabricChaincodeWithCallback invokes the baas.InstallFabricChaincode API asynchronously
// api document: https://help.aliyun.com/api/baas/installfabricchaincode.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) InstallFabricChaincodeWithCallback(request *InstallFabricChaincodeRequest, callback func(response *InstallFabricChaincodeResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *InstallFabricChaincodeResponse
		var err error
		defer close(result)
		response, err = client.InstallFabricChaincode(request)
...
func CreateInstallFabricChaincodeRequest() (request *InstallFabricChaincodeRequest) {
	request = &InstallFabricChaincodeRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Baas", "2018-12-21", "InstallFabricChaincode", "baas", "openAPI")
	return
}
...
func CreateInstallFabricChaincodeResponse() (response *InstallFabricChaincodeResponse) {
	response = &InstallFabricChaincodeResponse{
