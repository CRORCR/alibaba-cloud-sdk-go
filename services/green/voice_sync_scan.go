...
// api document: https://help.aliyun.com/api/green/voicesyncscan.html
...
func CreateVoiceSyncScanRequest() (request *VoiceSyncScanRequest) {
	...
	request.InitWithApiInfo("Green", "2018-05-09", "VoiceSyncScan", "/green/voice/syncscan", "green", "openAPI")
