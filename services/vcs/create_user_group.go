...
// api document: https://help.aliyun.com/api/vcs/createusergroup.html
...
type CreateUserGroupRequest struct {
	*requests.RpcRequest
	...
	ParentUserGroupId requests.Integer `position:"Body" name:"ParentUserGroupId"`
}
...
type CreateUserGroupResponse struct {
	*responses.BaseResponse
	...
	Data      DataInCreateUserGroup `json:"Data" xml:"Data"`
}
...
func CreateCreateUserGroupRequest() (request *CreateUserGroupRequest) {
	...
	request.InitWithApiInfo("Vcs", "2020-05-15", "CreateUserGroup", "vcs", "openAPI")
