...
// api document: https://help.aliyun.com/api/opensearch/describeappgroup.html
...
func CreateDescribeAppGroupRequest() (request *DescribeAppGroupRequest) {
	...
	request.InitWithApiInfo("OpenSearch", "2017-12-25", "DescribeAppGroup", "/v4/openapi/app-groups/[appGroupIdentity]", "opensearch", "openAPI")
