...
// api document: https://help.aliyun.com/api/opensearch/listsortscripts.html
...
func CreateListSortScriptsRequest() (request *ListSortScriptsRequest) {
	...
	request.InitWithApiInfo("OpenSearch", "2017-12-25", "ListSortScripts", "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appVersionId]/sort-scripts", "opensearch", "openAPI")
