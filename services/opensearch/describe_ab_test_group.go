...
func CreateDescribeABTestGroupRequest() (request *DescribeABTestGroupRequest) {
	...
	request.InitWithApiInfo("OpenSearch", "2017-12-25", "DescribeABTestGroup", "/v4/openapi/app-groups/[appGroupIdentity]/scenes/[sceneId]/groups/[groupId]", "opensearch", "openAPI")
