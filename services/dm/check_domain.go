...
// CheckDomain invokes the dm.CheckDomain API synchronously
// api document: https://help.aliyun.com/api/dm/checkdomain.html
...
// CheckDomainWithChan invokes the dm.CheckDomain API asynchronously
// api document: https://help.aliyun.com/api/dm/checkdomain.html
...
// CheckDomainWithCallback invokes the dm.CheckDomain API asynchronously
// api document: https://help.aliyun.com/api/dm/checkdomain.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateCheckDomainRequest() (request *CheckDomainRequest) {
	...
	request.InitWithApiInfo("Dm", "2015-11-23", "CheckDomain", "", "")
	return
}
