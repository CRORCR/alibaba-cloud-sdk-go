...
// api document: https://help.aliyun.com/api/dataworks-public/createqualityrelativenode.html
...
func CreateCreateQualityRelativeNodeRequest() (request *CreateQualityRelativeNodeRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateQualityRelativeNode", "dide", "openAPI")
