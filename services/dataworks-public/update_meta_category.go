...
// api document: https://help.aliyun.com/api/dataworks-public/updatemetacategory.html
...
func CreateUpdateMetaCategoryRequest() (request *UpdateMetaCategoryRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "UpdateMetaCategory", "dide", "openAPI")
