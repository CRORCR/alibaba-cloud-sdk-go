...
// api document: https://help.aliyun.com/api/dataworks-public/getbaselineconfig.html
...
func CreateGetBaselineConfigRequest() (request *GetBaselineConfigRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetBaselineConfig", "dide", "openAPI")
