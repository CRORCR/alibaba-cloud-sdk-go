...
// api document: https://help.aliyun.com/api/dataworks-public/createqualityentity.html
...
func CreateCreateQualityEntityRequest() (request *CreateQualityEntityRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateQualityEntity", "dide", "openAPI")
