...
// api document: https://help.aliyun.com/api/dataworks-public/createdagtest.html
...
func CreateCreateDagTestRequest() (request *CreateDagTestRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateDagTest", "dide", "openAPI")
