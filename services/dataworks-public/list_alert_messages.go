...
// api document: https://help.aliyun.com/api/dataworks-public/listalertmessages.html
...
func CreateListAlertMessagesRequest() (request *ListAlertMessagesRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "ListAlertMessages", "dide", "openAPI")
