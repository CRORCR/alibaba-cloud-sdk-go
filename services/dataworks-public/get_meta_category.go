...
// api document: https://help.aliyun.com/api/dataworks-public/getmetacategory.html
...
func CreateGetMetaCategoryRequest() (request *GetMetaCategoryRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetMetaCategory", "dide", "openAPI")
