...
// api document: https://help.aliyun.com/api/dataworks-public/getdataservicepublishedapi.html
...
func CreateGetDataServicePublishedApiRequest() (request *GetDataServicePublishedApiRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetDataServicePublishedApi", "dide", "openAPI")
