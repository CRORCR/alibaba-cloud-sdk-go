...
// api document: https://help.aliyun.com/api/dataworks-public/updatequalityrule.html
...
func CreateUpdateQualityRuleRequest() (request *UpdateQualityRuleRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "UpdateQualityRule", "dide", "openAPI")
