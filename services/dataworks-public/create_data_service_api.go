...
// api document: https://help.aliyun.com/api/dataworks-public/createdataserviceapi.html
...
func CreateCreateDataServiceApiRequest() (request *CreateDataServiceApiRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateDataServiceApi", "dide", "openAPI")
