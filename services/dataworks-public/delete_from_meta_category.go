...
// api document: https://help.aliyun.com/api/dataworks-public/deletefrommetacategory.html
...
func CreateDeleteFromMetaCategoryRequest() (request *DeleteFromMetaCategoryRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteFromMetaCategory", "dide", "openAPI")
