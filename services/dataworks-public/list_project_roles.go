...
// api document: https://help.aliyun.com/api/dataworks-public/listprojectroles.html
...
func CreateListProjectRolesRequest() (request *ListProjectRolesRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "ListProjectRoles", "dide", "openAPI")
