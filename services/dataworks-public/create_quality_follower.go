...
// api document: https://help.aliyun.com/api/dataworks-public/createqualityfollower.html
...
func CreateCreateQualityFollowerRequest() (request *CreateQualityFollowerRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateQualityFollower", "dide", "openAPI")
