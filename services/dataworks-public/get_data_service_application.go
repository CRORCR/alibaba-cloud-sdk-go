...
// api document: https://help.aliyun.com/api/dataworks-public/getdataserviceapplication.html
...
func CreateGetDataServiceApplicationRequest() (request *GetDataServiceApplicationRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetDataServiceApplication", "dide", "openAPI")
