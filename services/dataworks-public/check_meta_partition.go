...
// api document: https://help.aliyun.com/api/dataworks-public/checkmetapartition.html
...
func CreateCheckMetaPartitionRequest() (request *CheckMetaPartitionRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CheckMetaPartition", "dide", "openAPI")
