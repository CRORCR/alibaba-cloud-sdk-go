...
// api document: https://help.aliyun.com/api/dataworks-public/updatefolder.html
...
func CreateUpdateFolderRequest() (request *UpdateFolderRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "UpdateFolder", "dide", "openAPI")
