...
// api document: https://help.aliyun.com/api/dataworks-public/listinstances.html
...
func CreateListInstancesRequest() (request *ListInstancesRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "ListInstances", "dide", "openAPI")
