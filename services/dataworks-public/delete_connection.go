...
// api document: https://help.aliyun.com/api/dataworks-public/deleteconnection.html
...
func CreateDeleteConnectionRequest() (request *DeleteConnectionRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteConnection", "dide", "openAPI")
