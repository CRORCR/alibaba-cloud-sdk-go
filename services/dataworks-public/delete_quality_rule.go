...
// api document: https://help.aliyun.com/api/dataworks-public/deletequalityrule.html
...
func CreateDeleteQualityRuleRequest() (request *DeleteQualityRuleRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteQualityRule", "dide", "openAPI")
