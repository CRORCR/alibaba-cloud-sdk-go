...
// api document: https://help.aliyun.com/api/dataworks-public/checkmetatable.html
...
func CreateCheckMetaTableRequest() (request *CheckMetaTableRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CheckMetaTable", "dide", "openAPI")
