...
// api document: https://help.aliyun.com/api/dataworks-public/createqualityrule.html
...
func CreateCreateQualityRuleRequest() (request *CreateQualityRuleRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateQualityRule", "dide", "openAPI")
