...
// api document: https://help.aliyun.com/api/dataworks-public/getmetatablebasicinfo.html
...
func CreateGetMetaTableBasicInfoRequest() (request *GetMetaTableBasicInfoRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetMetaTableBasicInfo", "dide", "openAPI")
