...
// api document: https://help.aliyun.com/api/dataworks-public/getprojectdetail.html
...
func CreateGetProjectDetailRequest() (request *GetProjectDetailRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetProjectDetail", "dide", "openAPI")
