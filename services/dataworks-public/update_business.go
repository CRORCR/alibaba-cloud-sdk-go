...
// api document: https://help.aliyun.com/api/dataworks-public/updatebusiness.html
...
func CreateUpdateBusinessRequest() (request *UpdateBusinessRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "UpdateBusiness", "dide", "openAPI")
