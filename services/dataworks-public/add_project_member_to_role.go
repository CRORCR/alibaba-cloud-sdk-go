...
// api document: https://help.aliyun.com/api/dataworks-public/addprojectmembertorole.html
...
func CreateAddProjectMemberToRoleRequest() (request *AddProjectMemberToRoleRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "AddProjectMemberToRole", "dide", "openAPI")
