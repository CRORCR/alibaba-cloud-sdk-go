...
// api document: https://help.aliyun.com/api/dataworks-public/deleteremind.html
...
func CreateDeleteRemindRequest() (request *DeleteRemindRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteRemind", "dide", "openAPI")
