...
// api document: https://help.aliyun.com/api/dataworks-public/createfolder.html
...
func CreateCreateFolderRequest() (request *CreateFolderRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateFolder", "dide", "openAPI")
