...
// api document: https://help.aliyun.com/api/dataworks-public/deletefolder.html
...
func CreateDeleteFolderRequest() (request *DeleteFolderRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteFolder", "dide", "openAPI")
