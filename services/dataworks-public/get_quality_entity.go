...
// api document: https://help.aliyun.com/api/dataworks-public/getqualityentity.html
...
func CreateGetQualityEntityRequest() (request *GetQualityEntityRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetQualityEntity", "dide", "openAPI")
