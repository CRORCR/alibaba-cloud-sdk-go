...
// api document: https://help.aliyun.com/api/dataworks-public/establishrelationtabletobusiness.html
...
func CreateEstablishRelationTableToBusinessRequest() (request *EstablishRelationTableToBusinessRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "EstablishRelationTableToBusiness", "dide", "openAPI")
