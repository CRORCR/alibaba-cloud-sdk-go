...
// api document: https://help.aliyun.com/api/dataworks-public/restartinstance.html
...
func CreateRestartInstanceRequest() (request *RestartInstanceRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "RestartInstance", "dide", "openAPI")
