...
// api document: https://help.aliyun.com/api/dataworks-public/getmetatablelineage.html
...
func CreateGetMetaTableLineageRequest() (request *GetMetaTableLineageRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetMetaTableLineage", "dide", "openAPI")
