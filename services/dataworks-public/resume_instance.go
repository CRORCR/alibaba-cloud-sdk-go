...
// api document: https://help.aliyun.com/api/dataworks-public/resumeinstance.html
...
func CreateResumeInstanceRequest() (request *ResumeInstanceRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "ResumeInstance", "dide", "openAPI")
