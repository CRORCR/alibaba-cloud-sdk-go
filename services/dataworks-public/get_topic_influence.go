...
// api document: https://help.aliyun.com/api/dataworks-public/gettopicinfluence.html
...
func CreateGetTopicInfluenceRequest() (request *GetTopicInfluenceRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetTopicInfluence", "dide", "openAPI")
