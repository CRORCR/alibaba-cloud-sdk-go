...
// api document: https://help.aliyun.com/api/dataworks-public/createdagcomplement.html
...
func CreateCreateDagComplementRequest() (request *CreateDagComplementRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateDagComplement", "dide", "openAPI")
