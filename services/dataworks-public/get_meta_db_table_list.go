...
// api document: https://help.aliyun.com/api/dataworks-public/getmetadbtablelist.html
...
func CreateGetMetaDBTableListRequest() (request *GetMetaDBTableListRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetMetaDBTableList", "dide", "openAPI")
