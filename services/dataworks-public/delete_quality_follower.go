...
// api document: https://help.aliyun.com/api/dataworks-public/deletequalityfollower.html
...
func CreateDeleteQualityFollowerRequest() (request *DeleteQualityFollowerRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteQualityFollower", "dide", "openAPI")
