...
// api document: https://help.aliyun.com/api/dataworks-public/updatequalityfollower.html
...
func CreateUpdateQualityFollowerRequest() (request *UpdateQualityFollowerRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "UpdateQualityFollower", "dide", "openAPI")
