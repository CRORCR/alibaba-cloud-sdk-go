...
// api document: https://help.aliyun.com/api/dataworks-public/deletequalityrelativenode.html
...
func CreateDeleteQualityRelativeNodeRequest() (request *DeleteQualityRelativeNodeRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteQualityRelativeNode", "dide", "openAPI")
