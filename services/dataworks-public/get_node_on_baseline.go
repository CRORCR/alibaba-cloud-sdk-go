...
// api document: https://help.aliyun.com/api/dataworks-public/getnodeonbaseline.html
...
func CreateGetNodeOnBaselineRequest() (request *GetNodeOnBaselineRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetNodeOnBaseline", "dide", "openAPI")
