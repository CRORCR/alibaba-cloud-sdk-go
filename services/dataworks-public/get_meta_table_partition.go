...
// api document: https://help.aliyun.com/api/dataworks-public/getmetatablepartition.html
...
func CreateGetMetaTablePartitionRequest() (request *GetMetaTablePartitionRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetMetaTablePartition", "dide", "openAPI")
