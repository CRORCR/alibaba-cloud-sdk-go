...
// api document: https://help.aliyun.com/api/dataworks-public/deleteprojectmember.html
...
func CreateDeleteProjectMemberRequest() (request *DeleteProjectMemberRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteProjectMember", "dide", "openAPI")
