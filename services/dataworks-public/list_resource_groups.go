...
// api document: https://help.aliyun.com/api/dataworks-public/listresourcegroups.html
...
func CreateListResourceGroupsRequest() (request *ListResourceGroupsRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "ListResourceGroups", "dide", "openAPI")
