...
// api document: https://help.aliyun.com/api/dataworks-public/listconnections.html
...
func CreateListConnectionsRequest() (request *ListConnectionsRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "ListConnections", "dide", "openAPI")
