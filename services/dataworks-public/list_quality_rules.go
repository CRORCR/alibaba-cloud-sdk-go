...
// api document: https://help.aliyun.com/api/dataworks-public/listqualityrules.html
...
func CreateListQualityRulesRequest() (request *ListQualityRulesRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "ListQualityRules", "dide", "openAPI")
