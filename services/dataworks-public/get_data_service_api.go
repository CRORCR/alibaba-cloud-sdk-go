...
// api document: https://help.aliyun.com/api/dataworks-public/getdataserviceapi.html
...
func CreateGetDataServiceApiRequest() (request *GetDataServiceApiRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetDataServiceApi", "dide", "openAPI")
