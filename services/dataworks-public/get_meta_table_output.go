...
// api document: https://help.aliyun.com/api/dataworks-public/getmetatableoutput.html
...
func CreateGetMetaTableOutputRequest() (request *GetMetaTableOutputRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetMetaTableOutput", "dide", "openAPI")
