...
// api document: https://help.aliyun.com/api/dataworks-public/getmetacolumnlineage.html
...
func CreateGetMetaColumnLineageRequest() (request *GetMetaColumnLineageRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetMetaColumnLineage", "dide", "openAPI")
