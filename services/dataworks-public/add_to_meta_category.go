...
// api document: https://help.aliyun.com/api/dataworks-public/addtometacategory.html
...
func CreateAddToMetaCategoryRequest() (request *AddToMetaCategoryRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "AddToMetaCategory", "dide", "openAPI")
