...
// api document: https://help.aliyun.com/api/dataworks-public/getbaselinestatus.html
...
func CreateGetBaselineStatusRequest() (request *GetBaselineStatusRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetBaselineStatus", "dide", "openAPI")
