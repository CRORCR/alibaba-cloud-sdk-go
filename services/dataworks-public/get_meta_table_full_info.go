...
// api document: https://help.aliyun.com/api/dataworks-public/getmetatablefullinfo.html
...
func CreateGetMetaTableFullInfoRequest() (request *GetMetaTableFullInfoRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetMetaTableFullInfo", "dide", "openAPI")
