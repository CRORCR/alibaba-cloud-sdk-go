...
// api document: https://help.aliyun.com/api/dataworks-public/deletemetacategory.html
...
func CreateDeleteMetaCategoryRequest() (request *DeleteMetaCategoryRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteMetaCategory", "dide", "openAPI")
