...
// api document: https://help.aliyun.com/api/dataworks-public/getqualityfollower.html
...
func CreateGetQualityFollowerRequest() (request *GetQualityFollowerRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetQualityFollower", "dide", "openAPI")
