...
// api document: https://help.aliyun.com/api/dataworks-public/listbaselinestatuses.html
...
func CreateListBaselineStatusesRequest() (request *ListBaselineStatusesRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "ListBaselineStatuses", "dide", "openAPI")
