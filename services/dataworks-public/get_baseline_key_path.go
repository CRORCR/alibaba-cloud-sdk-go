...
// api document: https://help.aliyun.com/api/dataworks-public/getbaselinekeypath.html
...
func CreateGetBaselineKeyPathRequest() (request *GetBaselineKeyPathRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetBaselineKeyPath", "dide", "openAPI")
