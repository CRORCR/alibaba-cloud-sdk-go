...
// api document: https://help.aliyun.com/api/dataworks-public/createconnection.html
...
func CreateCreateConnectionRequest() (request *CreateConnectionRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateConnection", "dide", "openAPI")
