...
// api document: https://help.aliyun.com/api/dataworks-public/createudffile.html
...
func CreateCreateUdfFileRequest() (request *CreateUdfFileRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateUdfFile", "dide", "openAPI")
