...
// api document: https://help.aliyun.com/api/dataworks-public/setsuccessinstance.html
...
func CreateSetSuccessInstanceRequest() (request *SetSuccessInstanceRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "SetSuccessInstance", "dide", "openAPI")
