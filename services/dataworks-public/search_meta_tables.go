...
// api document: https://help.aliyun.com/api/dataworks-public/searchmetatables.html
...
func CreateSearchMetaTablesRequest() (request *SearchMetaTablesRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "SearchMetaTables", "dide", "openAPI")
