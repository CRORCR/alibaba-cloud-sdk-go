...
// api document: https://help.aliyun.com/api/dataworks-public/deletequalityentity.html
...
func CreateDeleteQualityEntityRequest() (request *DeleteQualityEntityRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "DeleteQualityEntity", "dide", "openAPI")
