...
// api document: https://help.aliyun.com/api/dataworks-public/createmetacategory.html
...
func CreateCreateMetaCategoryRequest() (request *CreateMetaCategoryRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "CreateMetaCategory", "dide", "openAPI")
