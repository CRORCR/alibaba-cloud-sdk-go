...
// api document: https://help.aliyun.com/api/dataworks-public/listbusiness.html
...
func CreateListBusinessRequest() (request *ListBusinessRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "ListBusiness", "dide", "openAPI")
