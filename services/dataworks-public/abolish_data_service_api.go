...
// api document: https://help.aliyun.com/api/dataworks-public/abolishdataserviceapi.html
...
func CreateAbolishDataServiceApiRequest() (request *AbolishDataServiceApiRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "AbolishDataServiceApi", "dide", "openAPI")
