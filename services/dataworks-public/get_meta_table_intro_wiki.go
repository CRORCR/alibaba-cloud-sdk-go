...
// api document: https://help.aliyun.com/api/dataworks-public/getmetatableintrowiki.html
...
func CreateGetMetaTableIntroWikiRequest() (request *GetMetaTableIntroWikiRequest) {
	...
	request.InitWithApiInfo("dataworks-public", "2020-05-18", "GetMetaTableIntroWiki", "dide", "openAPI")
