...
// GetProject invokes the maxcompute.GetProject API synchronously
// api document: https://help.aliyun.com/api/maxcompute/getproject.html
...
// GetProjectWithChan invokes the maxcompute.GetProject API asynchronously
// api document: https://help.aliyun.com/api/maxcompute/getproject.html
...
// GetProjectWithCallback invokes the maxcompute.GetProject API asynchronously
// api document: https://help.aliyun.com/api/maxcompute/getproject.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateGetProjectRequest() (request *GetProjectRequest) {
	...
	request.InitWithApiInfo("MaxCompute", "2019-06-12", "GetProject", "", "")
	return
}
