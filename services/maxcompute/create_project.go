...
// CreateProject invokes the maxcompute.CreateProject API synchronously
// api document: https://help.aliyun.com/api/maxcompute/createproject.html
...
// CreateProjectWithChan invokes the maxcompute.CreateProject API asynchronously
// api document: https://help.aliyun.com/api/maxcompute/createproject.html
...
// CreateProjectWithCallback invokes the maxcompute.CreateProject API asynchronously
// api document: https://help.aliyun.com/api/maxcompute/createproject.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
type CreateProjectRequest struct {
	*requests.RpcRequest
	OdpsRegionId          string `position:"Body" name:"OdpsRegionId"`
	ProjectName           string `position:"Body" name:"ProjectName"`
	OdpsSpecificationType string `position:"Body" name:"OdpsSpecificationType"`
