...
// FindAllLinkRule invokes the csb.FindAllLinkRule API synchronously
// api document: https://help.aliyun.com/api/csb/findalllinkrule.html
func (client *Client) FindAllLinkRule(request *FindAllLinkRuleRequest) (response *FindAllLinkRuleResponse, err error) {
	response = CreateFindAllLinkRuleResponse()
	err = client.DoAction(request, response)
	return
}

// FindAllLinkRuleWithChan invokes the csb.FindAllLinkRule API asynchronously
// api document: https://help.aliyun.com/api/csb/findalllinkrule.html
...
func (client *Client) FindAllLinkRuleWithChan(request *FindAllLinkRuleRequest) (<-chan *FindAllLinkRuleResponse, <-chan error) {
	responseChan := make(chan *FindAllLinkRuleResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.FindAllLinkRule(request)
		if err != nil {
			errChan <- err
		} else {
...
// FindAllLinkRuleWithCallback invokes the csb.FindAllLinkRule API asynchronously
// api document: https://help.aliyun.com/api/csb/findalllinkrule.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) FindAllLinkRuleWithCallback(request *FindAllLinkRuleRequest, callback func(response *FindAllLinkRuleResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *FindAllLinkRuleResponse
		var err error
		defer close(result)
		response, err = client.FindAllLinkRule(request)
...
func CreateFindAllLinkRuleRequest() (request *FindAllLinkRuleRequest) {
	request = &FindAllLinkRuleRequest{
...
func CreateFindAllLinkRuleResponse() (response *FindAllLinkRuleResponse) {
	response = &FindAllLinkRuleResponse{
