...
// GetConsoleSLO invokes the csb.GetConsoleSLO API synchronously
// api document: https://help.aliyun.com/api/csb/getconsoleslo.html
func (client *Client) GetConsoleSLO(request *GetConsoleSLORequest) (response *GetConsoleSLOResponse, err error) {
	response = CreateGetConsoleSLOResponse()
	err = client.DoAction(request, response)
	return
}

// GetConsoleSLOWithChan invokes the csb.GetConsoleSLO API asynchronously
// api document: https://help.aliyun.com/api/csb/getconsoleslo.html
...
func (client *Client) GetConsoleSLOWithChan(request *GetConsoleSLORequest) (<-chan *GetConsoleSLOResponse, <-chan error) {
	responseChan := make(chan *GetConsoleSLOResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.GetConsoleSLO(request)
		if err != nil {
			errChan <- err
		} else {
...
// GetConsoleSLOWithCallback invokes the csb.GetConsoleSLO API asynchronously
// api document: https://help.aliyun.com/api/csb/getconsoleslo.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) GetConsoleSLOWithCallback(request *GetConsoleSLORequest, callback func(response *GetConsoleSLOResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *GetConsoleSLOResponse
		var err error
		defer close(result)
		response, err = client.GetConsoleSLO(request)
...
func CreateGetConsoleSLOResponse() (response *GetConsoleSLOResponse) {
	response = &GetConsoleSLOResponse{
