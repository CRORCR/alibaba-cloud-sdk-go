...
// DescribeOrderInstanceList invokes the cas.DescribeOrderInstanceList API synchronously
// api document: https://help.aliyun.com/api/cas/describeorderinstancelist.html
func (client *Client) DescribeOrderInstanceList(request *DescribeOrderInstanceListRequest) (response *DescribeOrderInstanceListResponse, err error) {
	response = CreateDescribeOrderInstanceListResponse()
	err = client.DoAction(request, response)
	return
}

// DescribeOrderInstanceListWithChan invokes the cas.DescribeOrderInstanceList API asynchronously
// api document: https://help.aliyun.com/api/cas/describeorderinstancelist.html
...
func (client *Client) DescribeOrderInstanceListWithChan(request *DescribeOrderInstanceListRequest) (<-chan *DescribeOrderInstanceListResponse, <-chan error) {
	responseChan := make(chan *DescribeOrderInstanceListResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.DescribeOrderInstanceList(request)
		if err != nil {
			errChan <- err
		} else {
...
// DescribeOrderInstanceListWithCallback invokes the cas.DescribeOrderInstanceList API asynchronously
// api document: https://help.aliyun.com/api/cas/describeorderinstancelist.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) DescribeOrderInstanceListWithCallback(request *DescribeOrderInstanceListRequest, callback func(response *DescribeOrderInstanceListResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *DescribeOrderInstanceListResponse
		var err error
		defer close(result)
		response, err = client.DescribeOrderInstanceList(request)
...
func CreateDescribeOrderInstanceListRequest() (request *DescribeOrderInstanceListRequest) {
	request = &DescribeOrderInstanceListRequest{
...
func CreateDescribeOrderInstanceListResponse() (response *DescribeOrderInstanceListResponse) {
	response = &DescribeOrderInstanceListResponse{
