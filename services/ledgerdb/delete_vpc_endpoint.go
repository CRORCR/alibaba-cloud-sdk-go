...
// DeleteVpcEndpoint invokes the ledgerdb.DeleteVpcEndpoint API synchronously
// api document: https://help.aliyun.com/api/ledgerdb/deletevpcendpoint.html
...
// DeleteVpcEndpointWithChan invokes the ledgerdb.DeleteVpcEndpoint API asynchronously
// api document: https://help.aliyun.com/api/ledgerdb/deletevpcendpoint.html
...
// DeleteVpcEndpointWithCallback invokes the ledgerdb.DeleteVpcEndpoint API asynchronously
// api document: https://help.aliyun.com/api/ledgerdb/deletevpcendpoint.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
type DeleteVpcEndpointRequest struct {
	*requests.RpcRequest
	...
	VpcEndpointId string `position:"Query" name:"VpcEndpointId"`
}
...
func CreateDeleteVpcEndpointRequest() (request *DeleteVpcEndpointRequest) {
	...
	request.InitWithApiInfo("ledgerdb", "2019-11-22", "DeleteVpcEndpoint", "ledgerdb", "openAPI")
	return
}
