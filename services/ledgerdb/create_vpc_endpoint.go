...
// CreateVpcEndpoint invokes the ledgerdb.CreateVpcEndpoint API synchronously
// api document: https://help.aliyun.com/api/ledgerdb/createvpcendpoint.html
...
// CreateVpcEndpointWithChan invokes the ledgerdb.CreateVpcEndpoint API asynchronously
// api document: https://help.aliyun.com/api/ledgerdb/createvpcendpoint.html
...
// CreateVpcEndpointWithCallback invokes the ledgerdb.CreateVpcEndpoint API asynchronously
// api document: https://help.aliyun.com/api/ledgerdb/createvpcendpoint.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateCreateVpcEndpointRequest() (request *CreateVpcEndpointRequest) {
	...
	request.InitWithApiInfo("ledgerdb", "2019-11-22", "CreateVpcEndpoint", "ledgerdb", "openAPI")
	return
}
