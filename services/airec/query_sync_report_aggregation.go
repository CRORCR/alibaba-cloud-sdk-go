...
// api document: https://help.aliyun.com/api/airec/querysyncreportaggregation.html
...
func CreateQuerySyncReportAggregationRequest() (request *QuerySyncReportAggregationRequest) {
	...
	request.InitWithApiInfo("Airec", "2018-10-12", "QuerySyncReportAggregation", "/openapi/instances/[InstanceId]/sync-reports/aggregation", "airec", "openAPI")
