...
// api document: https://help.aliyun.com/api/airec/listdashboarddetailsflows.html
...
func CreateListDashboardDetailsFlowsRequest() (request *ListDashboardDetailsFlowsRequest) {
	...
	request.InitWithApiInfo("Airec", "2018-10-12", "ListDashboardDetailsFlows", "/openapi/instances/[InstanceId]/dashboard/details/flows", "airec", "openAPI")
