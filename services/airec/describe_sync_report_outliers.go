...
// api document: https://help.aliyun.com/api/airec/describesyncreportoutliers.html
...
func CreateDescribeSyncReportOutliersRequest() (request *DescribeSyncReportOutliersRequest) {
	...
	request.InitWithApiInfo("Airec", "2018-10-12", "DescribeSyncReportOutliers", "/openapi/instances/[InstanceId]/sync-reports/outliers", "airec", "openAPI")
