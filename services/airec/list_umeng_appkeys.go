...
// api document: https://help.aliyun.com/api/airec/listumengappkeys.html
...
func CreateListUmengAppkeysRequest() (request *ListUmengAppkeysRequest) {
	...
	request.InitWithApiInfo("Airec", "2018-10-12", "ListUmengAppkeys", "/openapi/umeng/appkeys", "airec", "openAPI")
