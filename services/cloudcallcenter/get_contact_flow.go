...
// GetContactFlow invokes the cloudcallcenter.GetContactFlow API synchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/getcontactflow.html
func (client *Client) GetContactFlow(request *GetContactFlowRequest) (response *GetContactFlowResponse, err error) {
	response = CreateGetContactFlowResponse()
	err = client.DoAction(request, response)
	return
}

// GetContactFlowWithChan invokes the cloudcallcenter.GetContactFlow API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/getcontactflow.html
...
func (client *Client) GetContactFlowWithChan(request *GetContactFlowRequest) (<-chan *GetContactFlowResponse, <-chan error) {
	responseChan := make(chan *GetContactFlowResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.GetContactFlow(request)
		if err != nil {
			errChan <- err
		} else {
...
// GetContactFlowWithCallback invokes the cloudcallcenter.GetContactFlow API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/getcontactflow.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) GetContactFlowWithCallback(request *GetContactFlowRequest, callback func(response *GetContactFlowResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *GetContactFlowResponse
		var err error
		defer close(result)
		response, err = client.GetContactFlow(request)
...
func CreateGetContactFlowRequest() (request *GetContactFlowRequest) {
	...
	request.InitWithApiInfo("CloudCallCenter", "2017-07-05", "GetContactFlow", "", "")
...
func CreateGetContactFlowResponse() (response *GetContactFlowResponse) {
	response = &GetContactFlowResponse{
