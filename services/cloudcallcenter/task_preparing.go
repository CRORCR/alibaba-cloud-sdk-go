...
// TaskPreparing invokes the cloudcallcenter.TaskPreparing API synchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/taskpreparing.html
...
// TaskPreparingWithChan invokes the cloudcallcenter.TaskPreparing API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/taskpreparing.html
...
// TaskPreparingWithCallback invokes the cloudcallcenter.TaskPreparing API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/taskpreparing.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateTaskPreparingRequest() (request *TaskPreparingRequest) {
	...
	request.InitWithApiInfo("CloudCallCenter", "2017-07-05", "TaskPreparing", "", "")
