...
// CreateSkillGroup invokes the cloudcallcenter.CreateSkillGroup API synchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/createskillgroup.html
...
// CreateSkillGroupWithChan invokes the cloudcallcenter.CreateSkillGroup API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/createskillgroup.html
...
// CreateSkillGroupWithCallback invokes the cloudcallcenter.CreateSkillGroup API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/createskillgroup.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateCreateSkillGroupRequest() (request *CreateSkillGroupRequest) {
	...
	request.InitWithApiInfo("CloudCallCenter", "2017-07-05", "CreateSkillGroup", "", "")
