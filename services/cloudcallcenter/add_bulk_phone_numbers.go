...
// AddBulkPhoneNumbers invokes the cloudcallcenter.AddBulkPhoneNumbers API synchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/addbulkphonenumbers.html
...
// AddBulkPhoneNumbersWithChan invokes the cloudcallcenter.AddBulkPhoneNumbers API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/addbulkphonenumbers.html
...
// AddBulkPhoneNumbersWithCallback invokes the cloudcallcenter.AddBulkPhoneNumbers API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/addbulkphonenumbers.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
type AddBulkPhoneNumbersRequest struct {
	*requests.RpcRequest
	...
	NumberGroupId *[]string `position:"Query" name:"NumberGroupId"  type:"Repeated"`
}
...
func CreateAddBulkPhoneNumbersRequest() (request *AddBulkPhoneNumbersRequest) {
	...
	request.InitWithApiInfo("CloudCallCenter", "2017-07-05", "AddBulkPhoneNumbers", "", "")
