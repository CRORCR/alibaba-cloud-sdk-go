...
// Decrypt invokes the cloudcallcenter.Decrypt API synchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/decrypt.html
...
// DecryptWithChan invokes the cloudcallcenter.Decrypt API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/decrypt.html
...
// DecryptWithCallback invokes the cloudcallcenter.Decrypt API asynchronously
// api document: https://help.aliyun.com/api/cloudcallcenter/decrypt.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
type DecryptRequest struct {
	*requests.RpcRequest
	...
	CypherText *[]string `position:"Query" name:"CypherText"  type:"Repeated"`
}
...
type DecryptResponse struct {
	*responses.BaseResponse
	...
	CypherContents CypherContentsInDecrypt `json:"CypherContents" xml:"CypherContents"`
}
...
func CreateDecryptRequest() (request *DecryptRequest) {
	...
	request.InitWithApiInfo("CloudCallCenter", "2017-07-05", "Decrypt", "", "")
