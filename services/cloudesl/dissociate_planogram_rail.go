...
func (client *Client) DissociatePlanogramRailWithChan(request *DissociatePlanogramRailRequest) (<-chan *DissociatePlanogramRailResponse, <-chan error) {
	...
	err := client.AddAsyncTask(func() {
		...
		defer close(errChan)
		response, err := client.DissociatePlanogramRail(request)
		if err != nil {
			errChan <- err
		} else {
...
func (client *Client) DissociatePlanogramRailWithCallback(request *DissociatePlanogramRailRequest, callback func(response *DissociatePlanogramRailResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *DissociatePlanogramRailResponse
		var err error
		defer close(result)
		response, err = client.DissociatePlanogramRail(request)
...
type DissociatePlanogramRailResponse struct {
...
// CreateDissociatePlanogramRailRequest creates a request to invoke DissociatePlanogramRail API
func CreateDissociatePlanogramRailRequest() (request *DissociatePlanogramRailRequest) {
	request = &DissociatePlanogramRailRequest{
...
// CreateDissociatePlanogramRailResponse creates a response to parse from DissociatePlanogramRail response
func CreateDissociatePlanogramRailResponse() (response *DissociatePlanogramRailResponse) {
	response = &DissociatePlanogramRailResponse{
