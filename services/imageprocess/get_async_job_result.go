...
// api document: https://help.aliyun.com/api/imageprocess/getasyncjobresult.html
...
func CreateGetAsyncJobResultRequest() (request *GetAsyncJobResultRequest) {
	...
	request.InitWithApiInfo("imageprocess", "2020-03-20", "GetAsyncJobResult", "imageprocess", "openAPI")
