...
func (client *Client) DescribeDirQuotasWithChan(request *DescribeDirQuotasRequest) (<-chan *DescribeDirQuotasResponse, <-chan error) {
	responseChan := make(chan *DescribeDirQuotasResponse, 1)
...
func (client *Client) DescribeDirQuotasWithCallback(request *DescribeDirQuotasRequest, callback func(response *DescribeDirQuotasResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *DescribeDirQuotasResponse
		var err error
		defer close(result)
		response, err = client.DescribeDirQuotas(request)
...
type DescribeDirQuotasResponse struct {
	*responses.BaseResponse
	...
	DirQuotaInfos []DescribeDirQuotasDirQuotaInfo0 `json:"DirQuotaInfos" xml:"DirQuotaInfos"`
}

type DescribeDirQuotasDirQuotaInfo0 struct {
	Path           string                            `json:"Path" xml:"Path"`
	DirInode       string                            `json:"DirInode" xml:"DirInode"`
	Status         string                            `json:"Status" xml:"Status"`
	UserQuotaInfos []DescribeDirQuotasUserQuotaInfo1 `json:"UserQuotaInfos" xml:"UserQuotaInfos"`
}

type DescribeDirQuotasUserQuotaInfo1 struct {
...
func CreateDescribeDirQuotasResponse() (response *DescribeDirQuotasResponse) {
	response = &DescribeDirQuotasResponse{
