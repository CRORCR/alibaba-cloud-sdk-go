...
// DeployConfiguration invokes the acms_open.DeployConfiguration API synchronously
// api document: https://help.aliyun.com/api/acms-open/deployconfiguration.html
...
// DeployConfigurationWithChan invokes the acms_open.DeployConfiguration API asynchronously
// api document: https://help.aliyun.com/api/acms-open/deployconfiguration.html
...
// DeployConfigurationWithCallback invokes the acms_open.DeployConfiguration API asynchronously
// api document: https://help.aliyun.com/api/acms-open/deployconfiguration.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateDeployConfigurationRequest() (request *DeployConfigurationRequest) {
	...
	request.InitWithApiInfo("acms-open", "2020-02-06", "DeployConfiguration", "/diamond-ops/pop/configuration", "acms", "openAPI")
