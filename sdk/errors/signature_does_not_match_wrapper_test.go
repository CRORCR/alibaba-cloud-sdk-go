...
func TestWrapNotMatch(t *testing.T) {
	...
	assert.Equal(t, "This may be a bug with the SDK and we hope you can submit this question in the github issue(https://github.com/CRORCR/alibaba-cloud-sdk-go/issues), thanks very much", se.Recommend())
}
